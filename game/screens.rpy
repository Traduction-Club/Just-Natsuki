                    ...
                    if category_length == 0:
                        ...
                        python:
                            ...
                            if random.randint(0, 999) == 1:
                                go_back_text = "Volver de bakaciones"
            ...
            if jn_utils.get_key_valid():
                textbutton _("Reiniciar"):
                    ...
                    action Show(
                        ...
                        message="¿Quieres RECARGAR o REINICIAR?",
                        yes_text="Recargar",
                        no_text="Reiniciar",
...
screen navigation():
    vbox:
        ...
        textbutton _("Discord") action OpenURL("https://www.trad-club.com/discord")
...
init python:
    def FileActionMod(name, page=None, **kwargs):
        if persistent.playthrough == 1 and not persistent.deleted_saves and renpy.current_screen().screen_name[0] == "load" and FileLoadable(name):
            return Show(screen="dialog", message="Error del archivo: \"characters/sayori.chr\"\n\nEl archivo falta o está dañado.",
                ok_action=Show(screen="dialog", message="El archivo de guardado está corrupto. Iniciando una nueva partida.", ok_action=Function(renpy.full_restart, label="start")))
        elif persistent.playthrough == 3 and renpy.current_screen().screen_name[0] == "save":
            return Show(screen="dialog", message="No necesitarás guardar más,\nademás, no sirve de nada cuando estamos aquí sentados sin hacer nada...", ok_action=Hide("dialog"))
        else:
            ...
            vbox:
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        textbutton _("Tras elegir") action Preference("after choices", "toggle")

                    vbox:
                        style_prefix "check"
                        label _("Clima")
                        textbutton _("Aleatorio") action ToggleField(
                            object=persistent,
                    ...
                    vbox:
                        style_prefix "check"
                        label _("Atuendos")
                        textbutton _("Auto cambio") action [
                            ToggleField(
                                object=persistent,
                    ...
                    vbox:
                        style_prefix "check"
                        label _("Temas")
                        textbutton _("Repetir ya vistos") action [
                            ToggleField(
                                object=persistent,
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        label _("Charla aleatoria: {0}".format(jn_preferences.random_topic_frequency.get_random_topic_frequency_description()))
                        ...
                        label _("Velocidad del modo auto")
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Reiniciar") action Quit(confirm=True)
            ...
            hbox:
                ...
                textbutton _("Lo haré yo mismo") action Hide("reload")
