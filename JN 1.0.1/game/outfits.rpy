...
init -1 python in jn_outfits:
    ...
    class JNWearable():
        ...
        def filter_wearables(
            ...
            return [
                ...
                if _wearable._m1_outfits__filter_wearable(
                    unlocked,
                    is_jn_wearable,
                    reference_name,
                    not_reference_name,
        ...
        def _m1_outfits__filter_wearable(
            self,
            unlocked=None,
            is_jn_wearable=None,
            reference_name=None,
    ...
    class JNOutfit():
        ...
        def filter_outfits(
            ...
            return [
                ...
                if _outfit._m1_outfits__filter_outfit(
                    unlocked,
                    is_jn_outfit,
                    not_reference_name,
                    has_accessory,
        ...
        def _m1_outfits__delete_save(self):
            """
        ...
        def _m1_outfits__filter_outfit(
            self,
            unlocked=None,
            is_jn_outfit=None,
            not_reference_name=None,
    ...
    def _m1_outfits__register_outfit(outfit, player_created=False):
        """
    ...
    def _m1_outfits__register_wearable(wearable):
        """
    ...
    def _check_wearable_sprites(wearable):
        ...
        for pose in store.JNPose:
            ...
            resource_path = os.path.join(
                _m1_outfits__WEARABLE_BASE_PATH,
                pose.name,
    ...
    def _load_wearable_from_json(json):
        ...
        if (
            ...
            _m1_outfits__register_wearable(wearable)
            return True
    ...
    def _load_outfit_from_json(json):
        ...
        if not json["clothes"] in _m1_outfits__ALL_WEARABLES:
            ...
            _m1_outfits__register_outfit(outfit)
            return True
    ...
    def unload_custom_outfits():
        ...
        """
        _m1_outfits__ALL_OUTFITS = JNOutfit.filter_outfits(
    ...
    def unload_custom_wearables():
        ...
        """
        _m1_outfits__ALL_WEARABLES = JNWearable.filter_wearables(
    ...
    def save_custom_outfit(outfit):
        ...
        try:
            ...
            _m1_outfits__register_outfit(outfit=new_custom_outfit, player_created=True)
    ...
    def delete_custom_outfit(outfit):
        ...
        if jn_utils.createDirectoryIfNotExists(_m1_outfits__CUSTOM_OUTFITS_DIRECTORY):
            ...
            _m1_outfits__delete_outfit(outfit)
    ...
    _m1_outfits__register_wearable(JNWearable(
    ...
    _m1_outfits__register_wearable(JNHairstyle(
    ...
    _m1_outfits__register_wearable(JNEyewear(
    ...
    _m1_outfits__register_wearable(JNAccessory(
    ...
    _m1_outfits__register_wearable(JNClothes(
    ...
    _m1_outfits__register_wearable(JNHeadgear(
    ...
    _m1_outfits__register_wearable(JNNecklace(
    ...
    _m1_outfits__register_outfit(JNOutfit(
    ...
    _m1_outfits__PAJAMA_CHOICE = get_outfit("jn_bunny_pajamas") if random.randint(0, 10) == 1 else get_outfit("jn_star_pajamas")
