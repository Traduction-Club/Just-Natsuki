...
init python in jn_nicknames:
    ...
    _m1_script0x2dnicknames__NATSUKI_NICKNAME_LOVED_LIST = {
        "^amazing$",
        "^angel$",
        "^(babe|baby|babygirl)$",
        "^babycakes$",
    ...
    _m1_script0x2dnicknames__NATSUKI_NICKNAME_DISLIKED_LIST = {
        "^(dad|daddy)$",
        "^father$",
        "^lily$",
    ...
    _m1_script0x2dnicknames__NATSUKI_NICKNAME_FUNNY_LIST = {
        "^catsuki$",
        "^gorgeous$",
        "^(hot|hotstuff|hottie)$",
        "^nyatsuki$",
    ...
    _m1_script0x2dnicknames__NATSUKI_NICKNAME_NOU_LIST = {
        "^adorkable$",
        "^baka$",
    ...
    _m1_script0x2dnicknames__PLAYER_NICKNAME_DISLIKED_LIST = {
        "^(dad|daddy)$",
        "^father$",
        "^papa$",
        "^(salvato|dansalvato)$",
    ...
    _m1_script0x2dnicknames__PLAYER_NICKNAME_FUNNY_LIST = {
        "^gorgeous$",
        "^(hot|hotstuff|hottie)$",
        "^(mom|mommy|mother)$",
        "^(mum|mummy|maam|ma'am)$",
    ...
    NATSUKI_LOVED_NICKNAME_REGEX = re.compile('|'.join(_m1_script0x2dnicknames__NATSUKI_NICKNAME_LOVED_LIST), re.IGNORECASE)
    NATSUKI_DISLIKED_NICKNAME_REGEX = re.compile('|'.join(_m1_script0x2dnicknames__NATSUKI_NICKNAME_DISLIKED_LIST), re.IGNORECASE)
    NATSUKI_FUNNY_NICKNAME_REGEX = re.compile('|'.join(_m1_script0x2dnicknames__NATSUKI_NICKNAME_FUNNY_LIST), re.IGNORECASE)
    NATSUKI_NOU_NICKNAME_REGEX = re.compile('|'.join(_m1_script0x2dnicknames__NATSUKI_NICKNAME_NOU_LIST), re.IGNORECASE)

    PLAYER_DISLIKED_NICKNAME_REGEX = re.compile('|'.join(_m1_script0x2dnicknames__PLAYER_NICKNAME_DISLIKED_LIST), re.IGNORECASE)
    PLAYER_FUNNY_NICKNAME_REGEX = re.compile('|'.join(_m1_script0x2dnicknames__PLAYER_NICKNAME_FUNNY_LIST), re.IGNORECASE)
