...
init -20 python:
    ...
    class JNRoom(object):
        ...
        def __init__(self, sunrise_hour, sunset_hour):
            ...
            self._m1_locations__is_showing_day_image = self.is_day()
        ...
        def is_showing_day_room(self):
            ...
            """
            return self._m1_locations__is_showing_day_image
        ...
        def check_redraw(self):
            ...
            if self.is_day() and self._m1_locations__is_showing_day_image is False:
            ...
            elif not self.is_day() and self._m1_locations__is_showing_day_image is True:
