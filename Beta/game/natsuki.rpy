    ...
    class Natsuki(object):
        ...
        def calculated_affinity_gain(base=1, bypass=False):
            ...
            if bypass:
                ...
                jn_utils.log("¡Se ha alcanzado el tope diario de afecto!")
        ...
        def check_reset_daily_affinity_gain():
            ...
            if not persistent.affinity_gain_reset_date:
                ...
                persistent.affinity_gain_reset_date = current_date
                jn_utils.log("Reinicio del tope diario de afecto; el nuevo tope es: {0}".format(persistent.affinity_daily_gain))
        ...
        def _getAffinityTierName():
            ...
            if affinity_state == jn_affinity.ENAMORED:
                ...
                store.jn_utils.log(
                    message="No se puede obtener el nombre del nivel para la afecto {0}; affinity_state es {1}".format(
